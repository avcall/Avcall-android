...
import com.avcall.app.runtimepermissions.PermissionsManager;
import com.avcall.app.runtimepermissions.PermissionsResultAction;
...
//				Toast.makeText(MainActivity.this, "All permissions have been granted", Toast.LENGTH_SHORT).show();
	...
	EMMessageListener messageListener = new EMMessageListener() {
		...
		public void onMessageReceived(List<EMMessage> messages) {
		    ...
		    for (EMMessage message : messages) {
		        AvcallHelper.getInstance().getNotifier().onNewMsg(message);
		    }
	...
	protected void onResume() {
		...
		// background
		AvcallHelper sdkHelper = AvcallHelper.getInstance();
