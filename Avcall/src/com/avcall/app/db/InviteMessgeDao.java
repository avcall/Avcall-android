...
public class InviteMessgeDao {
	...
	public Integer saveMessage(InviteMessage message){
		return AvcallDBManager.getInstance().saveMessage(message);
	}
	...
	public void updateMessage(int msgId,ContentValues values){
		AvcallDBManager.getInstance().updateMessage(msgId, values);
	}
	...
	public List<InviteMessage> getMessagesList(){
		return AvcallDBManager.getInstance().getMessagesList();
	}
	
	public void deleteMessage(String from){
		AvcallDBManager.getInstance().deleteMessage(from);
	}
	
	public int getUnreadMessagesCount(){
	    return AvcallDBManager.getInstance().getUnreadNotifyCount();
	}
	
	public void saveUnreadMessageCount(int count){
		AvcallDBManager.getInstance().setUnreadNotifyCount(count);
	}
}
