...
public class AvcallDBManager {
    static private AvcallDBManager dbMgr = new AvcallDBManager();
    private DbOpenHelper dbHelper;
    
    private AvcallDBManager(){
        dbHelper = DbOpenHelper.getInstance(AvcallApplication.getInstance().getApplicationContext());
    }
    
    public static synchronized AvcallDBManager getInstance(){
        if(dbMgr == null){
            dbMgr = new AvcallDBManager();
        }
        return dbMgr;
    }
